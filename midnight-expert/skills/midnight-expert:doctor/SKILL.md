...
- If the user says **yes**: invoke the `midnight-tooling:doctor` command via its Tome MCP prompt (not the `Skill` tool) and wait for it and all 5 background agents to complete.
