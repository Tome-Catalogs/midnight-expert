...
- Whether compilation/execution might resolve it (the orchestrator decides whether to dispatch `midnight-verify:contract-writer` or `midnight-verify:zkir-checker`)
