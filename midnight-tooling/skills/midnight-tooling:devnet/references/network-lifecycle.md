...
_Every `midnight-tooling:devnet <subcommand>` invocation below is made through the `midnight-tooling:devnet` command's Tome MCP prompt — not as a slash command._
