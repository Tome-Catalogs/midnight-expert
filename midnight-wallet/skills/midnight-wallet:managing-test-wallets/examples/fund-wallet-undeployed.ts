...
// to the wallet derived from this seed. Load the midnight-tooling:devnet
// skill via Tome's get_skill MCP tool (not the Skill tool) — see its
// genesis-seed section.
