...
>
> 1. Load the `compact-core:compact-review` skill via Tome's `get_skill` MCP tool (not the `Skill` tool)
...
Files to review: [INSERT FILE LIST].
Load the `compact-core:compact-review` skill via Tome's `get_skill` MCP tool (not the `Skill` tool). Read the security-review reference from the Category Reference Map. Apply every checklist item systematically. Report findings using the structured output format with severity levels (Critical, High, Medium, Low, Suggestions). End with Positive Highlights.
...
Files to review: [INSERT FILE LIST].
Load the `compact-core:compact-review` skill via Tome's `get_skill` MCP tool (not the `Skill` tool). Read the token-security-review reference from the Category Reference Map. Apply every checklist item systematically. Report findings using the structured output format with severity levels (Critical, High, Medium, Low, Suggestions). End with Positive Highlights.
...
Files to review: [INSERT FILE LIST].
Load the `compact-core:compact-review` skill via Tome's `get_skill` MCP tool (not the `Skill` tool). Read the concurrency-review reference from the Category Reference Map. Apply every checklist item systematically. Report findings using the structured output format with severity levels (Critical, High, Medium, Low, Suggestions). End with Positive Highlights.
...
Files to review: [INSERT FILE LIST].
Load the `compact-core:compact-review` skill via Tome's `get_skill` MCP tool (not the `Skill` tool). Read the compilation-review reference from the Category Reference Map. Apply every checklist item systematically. Report findings using the structured output format with severity levels (Critical, High, Medium, Low, Suggestions). End with Positive Highlights.
...
Files to review: [INSERT FILE LIST].
Load the `compact-core:compact-review` skill via Tome's `get_skill` MCP tool (not the `Skill` tool). Read the performance-review reference from the Category Reference Map. Apply every checklist item systematically. Report findings using the structured output format with severity levels (Critical, High, Medium, Low, Suggestions). End with Positive Highlights.
...
Files to review: [INSERT FILE LIST].
Load the `compact-core:compact-review` skill via Tome's `get_skill` MCP tool (not the `Skill` tool). Read the architecture-review reference from the Category Reference Map. Apply every checklist item systematically. Report findings using the structured output format with severity levels (Critical, High, Medium, Low, Suggestions). End with Positive Highlights.
...
Files to review: [INSERT FILE LIST].
Load the `compact-core:compact-review` skill via Tome's `get_skill` MCP tool (not the `Skill` tool). Read the code-quality-review reference from the Category Reference Map. Apply every checklist item systematically. Report findings using the structured output format with severity levels (Critical, High, Medium, Low, Suggestions). End with Positive Highlights.
...
Files to review: [INSERT FILE LIST].
Load the `compact-core:compact-review` skill via Tome's `get_skill` MCP tool (not the `Skill` tool). Read the testing-review reference from the Category Reference Map. Apply every checklist item systematically. Report findings using the structured output format with severity levels (Critical, High, Medium, Low, Suggestions). End with Positive Highlights.
...
Files to review: [INSERT FILE LIST].
Load the `compact-core:compact-review` skill via Tome's `get_skill` MCP tool (not the `Skill` tool). Read the documentation-review reference from the Category Reference Map. Apply every checklist item systematically. Report findings using the structured output format with severity levels (Critical, High, Medium, Low, Suggestions). End with Positive Highlights.
...
After all reviewer agents complete, invoke the `midnight-verify:verify` command via its Tome MCP prompt (not the `Skill` tool and not a slash command) on the contract for mechanical verification, passing:
